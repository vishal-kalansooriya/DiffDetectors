...
<div id="mainImages">
    ...
    <img src="content/puzzles/1/wrong.png" alt="img">
</div>
<div id="bottom">
    <div>
...
<section id="questionCorrect" class="infoBox correct" style="display: none;">
    <span>
        ...
        <button class="greenButton" onclick="questionCorrect.style.display='none';timePopup.style.display='none';"><svg viewBox="0 0 16 16"><path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/></svg>I Understand</button>
    </span>
</section>
<section id="questionWrong" class="infoBox wrong" style="display: none;">
    <span>
        ...
        <button class="greenButton" onclick="questionWrong.style.display='none';timePopup.style.display='none';"><svg viewBox="0 0 16 16"><path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/></svg>I Understand</button>
    </span>
</section>
<?php
